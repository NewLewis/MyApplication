...
import com.example.rui12.myapplication.adapter.RecyclerViewPagerAdapter2;
...
public class RecyclerViewFragment2 extends Fragment {
    public static Fragment newInstance(){return  new RecyclerViewFragment2();}
    ...
    private void initRecycleView(View view){
        ...
        //初始化一个adapter
        RecyclerViewPagerAdapter2 recyclerViewPagerAdapter2 = new RecyclerViewPagerAdapter2(getActivity(),items,2);
        //设置adapter的点击事件
        recyclerViewPagerAdapter2.setmOnItemClickListener(new RecyclerViewPagerAdapter2.OnItemClickListener() {
            @Override
        ...
        mRecyclerView.setAdapter(recyclerViewPagerAdapter2);
    }
}